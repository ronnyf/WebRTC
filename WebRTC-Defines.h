...
//  WebRTC
//
//  Created by Falk, Ronny on 1/21/24.
//
...
#ifndef WebRTC_Defines_h
#define WebRTC_Defines_h
...
//experimental:begin
#ifdef WEBRTC_ENABLE_DEPRECATED_OPENGLES
#undef WEBRTC_ENABLE_DEPRECATED_OPENGLES
#endif
//experimental:end
