...
PROTOBUF_CONSTEXPR RtpPacket::RtpPacket(
  ...
  , /*decltype(_impl_.incoming_)*/ false

  , /*decltype(_impl_.type_)*/ 0

  , /*decltype(_impl_.packet_length_)*/ 0u

  , /*decltype(_impl_.probe_cluster_id_)*/ 0
} {}
...
PROTOBUF_CONSTEXPR VideoReceiveConfig::VideoReceiveConfig(
    ...
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.rtx_map_)*/{}
  , /*decltype(_impl_.header_extensions_)*/{}
  , /*decltype(_impl_.decoders_)*/{}
  , /*decltype(_impl_.remote_ssrc_)*/ 0u

  , /*decltype(_impl_.local_ssrc_)*/ 0u

  , /*decltype(_impl_.remb_)*/ false

  , /*decltype(_impl_.rtcp_mode_)*/ 1
} {}
...
PROTOBUF_CONSTEXPR RtxConfig::RtxConfig(
  ...
  , /*decltype(_impl_.rtx_payload_type_)*/ 0
} {}
...
PROTOBUF_CONSTEXPR VideoSendConfig::VideoSendConfig(
    ...
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.ssrcs_)*/ {}

  , /*decltype(_impl_.header_extensions_)*/{}
  , /*decltype(_impl_.rtx_ssrcs_)*/ {}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::Event_EventType_IsValid(static_cast<int>(val)))) {
...
RtpPacket::RtpPacket(const RtpPacket& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.incoming_) {}

    , decltype(_impl_.type_) {}

    , decltype(_impl_.packet_length_) {}

    , decltype(_impl_.probe_cluster_id_) {}
  };
  ...
  ::memcpy(&_impl_.incoming_, &from._impl_.incoming_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.probe_cluster_id_) -
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 8)) {
          ...
          _impl_.incoming_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 16)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::MediaType_IsValid(static_cast<int>(val)))) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 40)) {
          ...
          _impl_.probe_cluster_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
...
::uint8_t* RtpPacket::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        5, this->_internal_probe_cluster_id(), target);
  }
...
RtcpPacket::RtcpPacket(const RtcpPacket& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  RtcpPacket* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.packet_data_) {}
...
::uint8_t* LossBasedBweUpdate::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        3, this->_internal_total_packets(), target);
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 16)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::DelayBasedBweUpdate_DetectorState_IsValid(static_cast<int>(val)))) {
...
VideoReceiveConfig::VideoReceiveConfig(const VideoReceiveConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  VideoReceiveConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.rtx_map_){from._impl_.rtx_map_}
    , decltype(_impl_.header_extensions_){from._impl_.header_extensions_}
    , decltype(_impl_.decoders_){from._impl_.decoders_}
    , decltype(_impl_.remote_ssrc_) {}

    , decltype(_impl_.local_ssrc_) {}

    , decltype(_impl_.remb_) {}

    , decltype(_impl_.rtcp_mode_) {}
  };

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.remote_ssrc_, &from._impl_.remote_ssrc_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.rtcp_mode_) -
    reinterpret_cast<char*>(&_impl_.remote_ssrc_)) + sizeof(_impl_.rtcp_mode_));
...
inline void VideoReceiveConfig::SharedCtor(::_pb::Arena* arena) {
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.rtx_map_){arena}
    , decltype(_impl_.header_extensions_){arena}
    , decltype(_impl_.decoders_){arena}
    , decltype(_impl_.remote_ssrc_) { 0u }
...
inline void VideoReceiveConfig::SharedDtor() {
  ABSL_DCHECK(GetArenaForAllocation() == nullptr);
  _internal_mutable_rtx_map()->~RepeatedPtrField();
  _internal_mutable_header_extensions()->~RepeatedPtrField();
  _internal_mutable_decoders()->~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 24)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::VideoReceiveConfig_RtcpMode_IsValid(static_cast<int>(val)))) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 32)) {
          ...
          _impl_.remb_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
...
void VideoReceiveConfig::MergeFrom(const VideoReceiveConfig& from) {
  ...
  _this->_internal_mutable_rtx_map()->MergeFrom(from._internal_rtx_map());
  _this->_internal_mutable_header_extensions()->MergeFrom(from._internal_header_extensions());
  _this->_internal_mutable_decoders()->MergeFrom(from._internal_decoders());
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
...
void VideoReceiveConfig::InternalSwap(VideoReceiveConfig* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  _internal_mutable_rtx_map()->InternalSwap(other->_internal_mutable_rtx_map());
  _internal_mutable_header_extensions()->InternalSwap(other->_internal_mutable_header_extensions());
  _internal_mutable_decoders()->InternalSwap(other->_internal_mutable_decoders());
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
DecoderConfig::DecoderConfig(const DecoderConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  DecoderConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.name_) {}
...
RtpHeaderExtension::RtpHeaderExtension(const RtpHeaderExtension& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  RtpHeaderExtension* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.name_) {}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 16)) {
          ...
          _impl_.rtx_payload_type_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else {
          goto handle_unusual;
        }
...
::uint8_t* RtxConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        2, this->_internal_rtx_payload_type(), target);
  }
...
RtxMap::RtxMap(const RtxMap& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  RtxMap* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.config_){nullptr}
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  if ((from._impl_._has_bits_[0] & 0x00000001u) != 0) {
    _this->_impl_.config_ = new ::webrtc::rtclog::RtxConfig(*from._impl_.config_);
  }
  _this->_impl_.payload_type_ = from._impl_.payload_type_;
...
VideoSendConfig::VideoSendConfig(const VideoSendConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  VideoSendConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.ssrcs_) { from._impl_.ssrcs_ }

    , decltype(_impl_.header_extensions_){from._impl_.header_extensions_}
    , decltype(_impl_.rtx_ssrcs_) { from._impl_.rtx_ssrcs_ }

    , decltype(_impl_.encoder_){nullptr}
    , decltype(_impl_.rtx_payload_type_) {}
  };

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  if ((from._impl_._has_bits_[0] & 0x00000001u) != 0) {
    _this->_impl_.encoder_ = new ::webrtc::rtclog::EncoderConfig(*from._impl_.encoder_);
  }
  _this->_impl_.rtx_payload_type_ = from._impl_.rtx_payload_type_;
...
inline void VideoSendConfig::SharedCtor(::_pb::Arena* arena) {
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.ssrcs_) { arena }

    , decltype(_impl_.header_extensions_){arena}
    , decltype(_impl_.rtx_ssrcs_) { arena }
...
inline void VideoSendConfig::SharedDtor() {
  ABSL_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.ssrcs_.~RepeatedField();
  _internal_mutable_header_extensions()->~RepeatedPtrField();
  _impl_.rtx_ssrcs_.~RepeatedField();
...
::uint8_t* VideoSendConfig::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_ssrcs_size(); i < n; ++i) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        1, this->_internal_ssrcs(i), target);
  }
  ...
  for (int i = 0, n = this->_internal_rtx_ssrcs_size(); i < n; ++i) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(
        3, this->_internal_rtx_ssrcs(i), target);
  }
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(
        4, this->_internal_rtx_payload_type(), target);
  }
...
void VideoSendConfig::MergeFrom(const VideoSendConfig& from) {
  ...
  _this->_impl_.ssrcs_.MergeFrom(from._impl_.ssrcs_);
  _this->_internal_mutable_header_extensions()->MergeFrom(from._internal_header_extensions());
  _this->_impl_.rtx_ssrcs_.MergeFrom(from._impl_.rtx_ssrcs_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
...
EncoderConfig::EncoderConfig(const EncoderConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  EncoderConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.name_) {}
...
AudioReceiveConfig::AudioReceiveConfig(const AudioReceiveConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  AudioReceiveConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.header_extensions_){from._impl_.header_extensions_}
...
AudioSendConfig::AudioSendConfig(const AudioSendConfig& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  AudioSendConfig* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.header_extensions_){from._impl_.header_extensions_}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 16)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::BweProbeResult_ResultType_IsValid(static_cast<int>(val)))) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 8)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::IceCandidatePairConfig_IceCandidatePairConfigType_IsValid(static_cast<int>(val)))) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 24)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::IceCandidatePairConfig_IceCandidateType_IsValid(static_cast<int>(val)))) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 32)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::IceCandidatePairConfig_Protocol_IsValid(static_cast<int>(val)))) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 40)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::IceCandidatePairConfig_NetworkType_IsValid(static_cast<int>(val)))) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 48)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::IceCandidatePairConfig_AddressFamily_IsValid(static_cast<int>(val)))) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 8)) {
          ::int32_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::webrtc::rtclog::IceCandidatePairEvent_IceCandidatePairEventType_IsValid(static_cast<int>(val)))) {
